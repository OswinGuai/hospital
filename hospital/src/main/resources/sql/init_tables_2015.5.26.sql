...
) ENGINE=InnoDB AUTO_INCREMENT=11111113 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `patient` VALUES (11111111,'测试一',NULL,'dddd',NULL),(11111112,'测试一',NULL,'11111',NULL);
...
CREATE TABLE `patient_card_bind` (
  `bind_code` bigint(20) NOT NULL AUTO_INCREMENT,
  `patient_id` bigint(20) NOT NULL,
...
INSERT INTO `patient_card_bind` VALUES (1,11111111,NULL,NULL,0);
...
-- Dump completed on 2015-05-26 17:24:00
